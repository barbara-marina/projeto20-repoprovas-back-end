...
CREATE TABLE "tests" (
    ...
    "teacherDisciplieId" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "tests" ADD CONSTRAINT "tests_teacherDisciplieId_fkey" FOREIGN KEY ("teacherDisciplieId") REFERENCES "teachersDisciplines"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
